...
// Requires <NotificationProvider> wrapping the app.
...
export default function NotificationBell() {
  const {
    swSupported, permission, subscribed, subscribing,
    history, historyLoading, unreadCount, hasMore,
    subscribe, unsubscribe, loadHistory, markRead,
  } = useNotifications();
      ...
      >
        ...
        {permission === 'denied' && (
          <div className="nb-denied">
            🚫 Push blocked in browser settings. Enable it in site permissions.
          </div>
        )}
